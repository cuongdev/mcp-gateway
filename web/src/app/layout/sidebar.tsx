...
import {
  Home, Server, Wrench, LayoutGrid, MessageSquare, Network, Boxes as PackageIcon, FolderTree, Workflow,
...
const groups: Group[] = [
  {
    ...
    items: [
      ...
      { to: '/virtual-tools', label: 'Virtual Tools', icon: Workflow },
  ...
  },
  {
    ...
    items: [
      { to: '/redaction', label: 'Redaction', icon: ShieldAlert },
    ],
  },
  {
